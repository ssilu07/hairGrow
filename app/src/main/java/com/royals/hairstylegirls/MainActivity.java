...
import static com.royals.hairstylegirls.services.Constant.CONTACT_URL;
import static com.royals.hairstylegirls.services.Constant.POLICY_URL;
...
import com.royals.hairstylegirls.adapter.CategoryAdapter;
import com.royals.hairstylegirls.adapter.SliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   MobileAds.initialize(this, initializationStatus -> {
        ...
        findViewById(R.id.fav).setOnClickListener(view -> {
            DetailsActivity.hairStyle = new Design("Favorite",R.drawable.design);
